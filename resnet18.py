...
if not args.eval:
    w = models.ResNet18_Weights.IMAGENET1K_V1 if args.pretrained else None
    ...
    if args.resume is None:
        if args.pretrained:
            ...
            model.fc = nn.Linear(512, 22, True)
        else:
    ...
    for i in range(cur_epoch, epochs):
        ...
        warmup_scheduler.step(i+1, t_losses.avg)
        ...
        if top1.avg > best and i+1 > 10:
            ...
            torch.save(checkpoint, f"resnet\\{i+1}.pth")
            best = top1.avg
